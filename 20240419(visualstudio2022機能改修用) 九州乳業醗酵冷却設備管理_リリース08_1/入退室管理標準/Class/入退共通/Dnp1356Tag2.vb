...
Public Class CHRW_DSU01
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetTagIDs() As List(Of TagID) Implements 共通.IRFIDリーダライタ.GetTagIDs
        'UID取得関数実行
    ...
    Public Function GetTagIDs_NoMoreThan(ByVal NumberOfTags As Integer, Optional ByRef NumberOfTagsFound As Integer = 0, Optional ByRef NumberOfTagsReturned As Integer = 0) As System.Collections.Generic.List(Of 共通.TagID) Implements 共通.IRFIDリーダライタ.GetTagIDs_NoMoreThan
        Return Nothing
    End Function

    Public Sub WriteUserTagID(ByVal TargetTagID As 共通.TagID, ByVal Binary() As Byte) Implements 共通.IRFIDリーダライタ.WriteUserTagID
