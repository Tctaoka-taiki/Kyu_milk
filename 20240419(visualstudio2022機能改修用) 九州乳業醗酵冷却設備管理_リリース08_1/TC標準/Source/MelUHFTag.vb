...
#Region "外部メソッド"
    ...
    ''' <returns>読み出しタグリスト</returns>
    ''' <remarks></remarks>
    Public Function GetTagIDs_NoMoreThan(ByVal NumberOfTags As Integer, Optional ByRef NumberOfTagsFound As Integer = Nothing, Optional ByRef NumberOfTagsReturned As Integer = Nothing) As List(Of TagID)
    ...
    ''' <param name="Binary">書き換え後のタグID</param>
    ''' <remarks></remarks>
    Public Sub WriteUserTagID(ByVal TargetTagID As TagID, ByVal Binary As Byte())
        Dim writeTag As New MelTag()
