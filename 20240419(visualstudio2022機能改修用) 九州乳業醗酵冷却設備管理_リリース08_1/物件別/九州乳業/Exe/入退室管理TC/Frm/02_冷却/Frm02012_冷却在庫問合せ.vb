...
Public Class Frm02012_冷却在庫問合せ
    ...
    Private Sub Frm02012_冷却在庫問合せ_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.lblロットNo.Text = ""
        Me.lbl品種名.Text = ""
    ...
    Private Sub 冷却生産品情報(ByVal 品種CD As String, ByVal ロットNo As String)
            ...
            With New CSqlEx
                ...
                If CUsrctl.gDp.gBlnReader(.gSQL文の取得, reader) Then
                    ...
                    While reader.Read
                        ...
                        Me.dgv生産データ.Item(4, i).Value = reader.GetValue(3) & "-" & reader.GetValue(4) & "-" & reader.GetValue(5)
                        Me.dgv生産データ.Item(5, i).Value = reader.GetValue(6)
                        合計受入数 += reader.GetValue(6)
                        Dim 所定冷却時間 As Integer = reader.GetValue(7)
                        Dim 冷却経過時間 As Integer = reader.GetValue(8)
                        Me.dgv生産データ.Item(6, i).Value = 所定冷却時間 & "分"
                        Me.dgv生産データ.Item(7, i).Value = 冷却経過時間 & "分"
                        i += 1
                    End While
    ...
    Private Sub btnF10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnF10.Click
        ...
        For i = 1 To Me.dgv生産データ.Rows.Count - 1
            ...
            Try
                With New CSql
                    ...
                    .gSubColumnValue("所定冷却時間", Me.dgv生産データ.Item(6, i).Value, True)
                    .gSubColumnValue("冷却経過時間", Me.dgv生産データ.Item(7, i).Value, True)
        ...
        With New CSqlEx
            ...
            CMdiMain.帳票出力(New 在庫実績_冷却, "***在庫実績（冷却）***", .gSQL文の取得, str条件)
        End With
