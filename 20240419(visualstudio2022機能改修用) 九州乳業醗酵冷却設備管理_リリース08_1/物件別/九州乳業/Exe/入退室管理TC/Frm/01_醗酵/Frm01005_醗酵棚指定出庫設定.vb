...
Public Class Frm01005_醗酵棚指定出庫設定
    '#####################################################################################
    '型
    '#####################################################################################
    ...
    Private Sub Frm01012_醗酵棚指定出庫_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        倉庫情報表示()
        Timer1.Start()
    End Sub
    ...
    Private Sub 倉庫情報表示()
        ...
        Try
            With New CSqlEx
                ...
                '8,9:出荷中(出庫中)
                '10:出庫ST(完了)
                .gSubWhere("(A.ステータス >= 6 AND A.ステータス <= 10)")
                .gSubWhere("A.棚指定出庫 = 1")
                '---------------------------------
