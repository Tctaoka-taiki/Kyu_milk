...
Public Class Dlg01005_棚指定出庫登録
    Private Sub Dlg01005_棚指定出庫登録_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '初期表示
        Select Case m画面モード
            Case 0  '醗酵
    ...
    Private Sub btnF1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnF1.Click
        If CMsg.gMsg_YesNo("棚指定出庫登録を行ってもよろしいですか？") = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
                ...
                If CUsrctl.gDp.gBlnReader(.gSQL文の取得, reader) Then
                    While reader.Read
                        If reader.GetValue(0).ToString = "" Then
                            ...
                            Exit Sub
                        Else
                            If reader.GetValue(7).ToString = 1 Then
                                CMsg.gMsg_エラー("既に棚指定出荷登録済です")
                                Me.txt列.Focus()
                                Me.txt列.Text = ""
                                Me.txt連.Text = ""
                                Me.txt段.Text = ""
