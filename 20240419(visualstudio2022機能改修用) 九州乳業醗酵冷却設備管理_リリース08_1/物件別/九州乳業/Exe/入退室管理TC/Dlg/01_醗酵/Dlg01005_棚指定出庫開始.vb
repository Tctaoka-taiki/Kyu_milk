...
Public Class Dlg01005_棚指定出庫開始
    Private Sub Dlg01005_棚指定出開始_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '初期表示
        Select Case m画面モード
            Case 0  '醗酵
    ...
    Private Sub btnF1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnF1.Click
        If CMsg.gMsg_YesNo("棚指定出庫を開始してもよろしいですか？") = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
            ...
            With New CSql
                ...
                Select Case m画面モード
                    ...
                    Case 1
                        ...
                        .gSubColumnValue("出庫順", 99, False)   '端数パレタイズ
                        .gSubWhere("列", txt列.Text, , , , , , , False)
                        .gSubWhere("連", txt連.Text, , , , , , , False)
                        .gSubWhere("段", txt段.Text, , , , , , , False)
                        .gSubWhere("ステータス = 27")
