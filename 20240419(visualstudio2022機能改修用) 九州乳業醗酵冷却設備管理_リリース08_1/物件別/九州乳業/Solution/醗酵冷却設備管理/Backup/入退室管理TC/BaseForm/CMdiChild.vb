...
#End Region
    ...
    Public Sub 有効btn設定(ByVal str機能名称 As String)
        'ログインユーザーの権限検索
        ...
        Try
            '機能権限情報の取得
            With New CSql
                .gSubSelect("DR管理者機能割当.権限ID")
                .gSubFrom("DR管理者機能割当")
                .gSubFrom("DM機能")
                .gSubWhere("DR管理者機能割当.機能ID = DM機能.機能ID")
                .gSubWhere("DR管理者機能割当.管理者ID", CMdiMain.gStrログイン管理者ID)
                .gSubWhere("DM機能.名称", str機能名称)
                ...
                While reader.Read
                    str権限 = reader.GetValue(0).ToString
                End While
            End With
            ...
            Select Case str権限
                ...
                Case "1"
                    ...
                    btn無効化(str権限)
                Case "2"
                    ' MessageBox.Show("表示・印刷")
                    btn無効化(str権限)
                Case "3"
                    ' MessageBox.Show("表示・印刷・更新")
                    btn無効化(str権限)
                Case Else
