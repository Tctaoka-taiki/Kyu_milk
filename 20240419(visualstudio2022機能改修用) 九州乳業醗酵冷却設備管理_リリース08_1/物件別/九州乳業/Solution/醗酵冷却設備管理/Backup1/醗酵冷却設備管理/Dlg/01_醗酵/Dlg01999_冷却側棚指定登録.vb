...
Public Class Dlg01999_冷却側棚指定登録

    Private Sub Dlg01999_冷却側棚指定登録_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            With New CSql
                ...
                Select Case m画面モード
                    ...
                    Case 2  '開始　※端数パレタイズ出荷となります
                        .gSubColumnValue("ステータス", 28, False)
                        .gSubColumnValue("出庫順", 99, False)
                        .gSubWhere("ステータス = 27")
                        .gSubWhere("棚指定出庫 = 1")
